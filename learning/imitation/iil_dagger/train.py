...
def process_args():
    ...
    parser.add_argument('--episode', '-i', default=100, type=int)
    parser.add_argument('--horizon', '-r', default=64, type=int)
    parser.add_argument('--learning-rate', '-l', default=4, type=int)
...
if __name__ == '__main__':
    ...
    learner = NeuralNetworkPolicy(
        ...
        graph_name=f"Horizon{config.horizon}_LR{learning_rates[config.learning_rate]}_Decay{mixing_decays[config.decay]}_BS{batch_size}_epochs{epochs}_",
